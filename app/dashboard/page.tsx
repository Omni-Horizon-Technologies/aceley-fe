...
export default function DashboardPage() {
  ...
  return <AppLayout><main className="mx-auto max-w-6xl space-y-8">
    <section className="relative overflow-hidden rounded-[24px] bg-[#312E81] px-6 py-6 text-white sm:px-8"><div className="relative z-10 flex items-center gap-4"><LottieMascot className="h-20 w-20 shrink-0 sm:h-24 sm:w-24" /><div><p className="text-sm font-semibold text-white/70">{greeting}</p><h1 className="mt-1 text-2xl font-black sm:text-3xl">Hi {name} 👋</h1><p className="mt-1 text-sm font-medium text-white/80">Ready when you are.</p></div></div><div className="absolute -right-10 -top-16 h-48 w-48 rounded-full bg-[#818CF8]/30 blur-2xl" /></section>
